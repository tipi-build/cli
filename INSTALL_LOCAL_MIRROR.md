...
- `ENV TIPI_INSTALL_SOURCE` (_i.e._ override for the cmake-re client binaries release package, override for https://github.com/tipi-build/cli/releases/download/v0.0.87/tipi-v0.0.87-linux-x86_64.zip)
