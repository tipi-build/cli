...
su tipi -c "cd ~ && curl -fsSL https://raw.githubusercontent.com/tipi-build/cli/v0.0.83/install/install_for_macos_linux.sh -o install_for_macos_linux.sh && /bin/bash install_for_macos_linux.sh"
